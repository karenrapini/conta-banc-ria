...
import Controller.Conta.Investimento.ContaInvestimentoPessoaFisicaController;
...
public class ContaInvestimentoPessoaFisicaView {
    ...
    public static void criar(PessoaFisicaEntity pessoaFisica){
        ...
        ContaInvestimentoPessoaFisicaController.criarConta(pessoaFisica, agenciaConta, numeroConta);
