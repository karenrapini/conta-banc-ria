package View.Conta.Investimento;

import Application.Aplicacao;
import Controller.Conta.Investimento.ContaInvestimentoPessoaJuridicaController;
...
public class ContaInvestimentoPessoaJuridicaView {

    static Scanner sc = new Scanner(System.in);
    static private PessoaJuridicaEntity pessoaJuridicaEntity;


    public static void criar(PessoaJuridicaEntity pessoaJuridica){
        ...
        ContaInvestimentoPessoaJuridicaController.criarConta(pessoaJuridica, agenciaConta, numeroConta);
        pessoaJuridicaEntity = pessoaJuridica;
