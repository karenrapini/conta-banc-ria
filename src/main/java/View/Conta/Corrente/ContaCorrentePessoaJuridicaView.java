...
import Controller.Conta.Corrente.ContaCorrentePessoaJuridicaController;
...
public class ContaCorrentePessoaJuridicaView {
    ...
    public static void criar(PessoaJuridicaEntity pessoaJuridica){
        ...
        ContaCorrentePessoaJuridicaController.criarConta(pessoaJuridica, agenciaConta, numeroConta);
